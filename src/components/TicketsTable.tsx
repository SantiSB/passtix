...
const TicketsTable: React.FC<TicketsTableProps> = ({ eventId }) => {
  ...
  if (isLoading) return <p className="p-4 text-center text-gray-400 bg-gray-800">Cargando tickets…</p>;
  if (isError)
    return <p className="p-4 text-center text-red-400 bg-gray-800">Error al cargar los tickets.</p>;
